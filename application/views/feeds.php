<script src="<?php echo base_url(); ?>assets/js/feed.js" type="text/javascript" charset="utf-8"></script>
<div class="container top">
    ...
    <div class="page-header users-header">
        <h2>
            <?php echo ucfirst($this->uri->segment(2)); ?> 
            <a  href="<?php echo site_url("feeds") . '/' . $this->uri->segment(2); ?>addFeed" class="btn btn-success">Add a new</a>
        </h2>
    </div>
...
//                  <a href="' . site_url("admin") . '/manufacturers/update/' . $row['tt_feed_id'] . '" class="btn btn-info">view & edit</a>  
                  echo '<a href="javascript:{}" onClick="deleteFeed(' . $row['tt_feed_id'] . ')" class="btn btn-danger">delete</a>
                </td>';
                        echo '</tr>';
                    }
                    ?>      
